...
Если новости нужны ещё и на стене сообщества VK — это отдельная настройка
уже после установки, через веб-панель и RSS-импорт VK, ключи в `.env` для
неё не нужны (подробно — в [SETUP.md](SETUP.md#публикация-в-vk)).
